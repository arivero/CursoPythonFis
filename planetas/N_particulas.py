...
def Evoluciona_dt(double *x, double *y,double *z,double *v_x,double *v_y,double *v_z):
    #int i;
...
def Calcula_Fuerza(double *x,double *y,double *z,double *Fx,double *Fy,double *Fz)
...
def Escribe_resultados(double time,double *x,double *y, double *z,double *v_x,double *v_y,double *v_z)
