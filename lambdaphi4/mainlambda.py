from lambdaconfig import *dir[LPATH]
#root
unsigned irr[256]
#update
     unsigned ir1
#update INMUTABLE NO SE USA
     unsigned ind, ig1, ig2, ig3
#update INMUTABLE SOLO SE PONEN A CERO EN INIT
       precision phi[V]
#inici medidas rrot update


#update INMUTABLE Ya no se reajustan, pero se inicializan desde fichero :-(
     obs[n_obs]
#medidas
     struct s_datos datos
#inici medidas root update
     v_dat[n_obs][maxit]
#root
     precision co[L], si[L]
#inici medidas
...
if __name__
  == '__main__'
    from root import lee_datos, lee_conf, escribe_medidas, escribe_conf,
    tiempo from inici import table, Direccionamientos,
    Inicializa from update import Metropolis from medida import Medida
#el bloque "compartido"
  from lambda import * main (void)
  unsigned low, high
